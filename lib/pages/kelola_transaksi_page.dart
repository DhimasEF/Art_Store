...
import 'detail_transaksi_admin.dart';// pastikan path sesuai
...
class _KelolaTransaksiPageState extends State<KelolaTransaksiPage> {
  ...
  Future<void> loadOrders() async {
    final result = await ApiService.getAllOrdersAdmin();
      ...
      for (var item in rawData) {
        ...
        if (!map.containsKey(orderId)) {
          map[orderId] = {
            ...
            "buyer_name": item['buyer_name'], // 🔥 penting buat admin
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (_) => DetailTransaksiAdminPage(
                                      order: order,     
